  ...
  handleItemUpdate = async (id, itemData) => {
    ...
    this.setState((prevState) => ({
      items: prevState.items.map((item) =>
        item.id === parseInt(id) ? newItem : item
      ),
    }));
  };
    ...
    return (
      <>
        ...
        <Route
          exact
          path="/"
          render={() => <ShowBasicItemsMap items={this.state.items} />}
        />
        <Route
          exact
          path="/categories"
        ...
        {this.state.categories.length > 0 && (
          <Route
            path="/categories/:id"
            render={(props) => (
              <CategoryPage {...props} categories={this.state.categories} />
            )}
          />
        )}
        ...
        <Route
          ...
          render={(props) => {
            ...
            const itemItem = this.state.items.find(
